...
// Power spectrum table:
    ...
    "is_PS_input_LCDM=1",     ";=0 for MG pk input, =1 for LCDM pk input (the code rescales it to MG)",":isinLCDM", 
...
// model
    "model=LCDM",                  ";LCDM, HS, DGP, HDKI",":m",    
    "mg_variant=baseline",         "; HDKI sub-variant selector (baseline, ...)", ":mgv",
    ...
    "mg1=1.0",                 "; MG param. h1 in HDKI. =1 in LCDM",":h1",  
    "mg2=0.0",                 "; MG param.  =0.0 in LCDM", 
    "mg3=0.0",                 "; MG param.  =0.0 in LCDM",
    "mg4=0.0",                 "; MG param.  =0.0 in LCDM",  
    "mg5=0.0",                 "; MG param.  =0.0 in LCDM",
    "mu0=1.0",                     "; MG parameter for (mu,Sigma) parametrization",
    "c1=1.0",                      "; MG parameter for scale-dependence",
    "c2=1.0",                      "; MG parameter for scale-dependence",
    "Lambda=0.0",                  "; MG parameter for scale-dependence",
    "beta_1=1.0",                  "; BZ parameter to modulate assymptotic scale-independent behavior in mu",
    "lambda_1=0.0",                "; BZ paramerer to module scale dependence in mu",
    "exp_s=1.0",                   "; BZ parameter to modulate time dependence, entering as a power of a",
    "beta_2=1.0",                  "; BZ parameter to modulate assymptotic scale-independent behavior in eta",
    "lambda_2=0.0",                "; BZ paramerer to module scale dependence in eta",
    "mu1=1.0",                     "; Bin parameter for (mu,eta) or (mu,Sigma) parameterization",
    "mu2=1.0",                     "; Bin parameter for (mu,eta) or (mu,Sigma) parameterization",
    "mu3=1.0",                     "; Bin parameter for (mu,eta) or (mu,Sigma) parameterization",
    "mu4=1.0",                     "; Bin parameter for (mu,eta) or (mu,Sigma) parameterization",
    "z_div=1.0",                      "; redshift at which the transition between the two bins occurs",
    "z_TGR=2.0",                      "; redshift below which GR is to be tested",
    "z_tw=0.05",                       "; transition width for the hyperbolic tangent function.",
    "k_tw=0.001",                       "; transition width between k bins",
    "k_c=0.01",                        "; parameter that separates scale-bins",
// chatty
